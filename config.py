...
BOT_TOKEN = "7324085779:AAFWC3DCwFe6tH5DX8tKRtsP10U4beOV4rQ"
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/timepassmarkus04/Amrithaa",
)
...
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", 999999999))
